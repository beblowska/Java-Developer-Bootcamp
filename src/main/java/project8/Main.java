...
public class Main {
    public static void main(String[] args) {
        ...
        menu.add(new Pizza(true, Arrays.asList(Ingredients.MOZARELLA, Ingredients.TOMATO, Ingredients.PEPPERS), 300, "Vegetariana"));
        menu.add(new Pizza(false, Arrays.asList(Ingredients.MOZARELLA, Ingredients.SALAMI, Ingredients.ONION), 400, "Salami"));
        menu.add(new Pizza(true, Arrays.asList(Ingredients.MOZARELLA, Ingredients.TOMATO, Ingredients.PEPPERS), 350, "Margherita"));
